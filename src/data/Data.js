...
export const MainSection = {
  ...
  text2:
    "At Uphill Travels, we believe that every journey is an opportunity for adventure, discovery and unfrogettable experience",
  btntext: "booking Now",
...
export const BigPromoSection = {
  ...
  text2:
    "Big Promo Alert! Are your ready for the ultimate adventure at unbeatable price? Uphill Travels is thrilled to announce our lastest Big Promo, offering your incredible deals on your dream vacations! ",
  btntext: "book Now",
  imagedata: [
    {
...
export const bannerSection = {
  ...
  text2: "adventure? Connect with Uphill Travels today",
...
export const BestSection = {
  ...
  title2:
    "Join us for an unforgettable experience at the most anticipated event of the year. Discover the magic and excitement that awaits you.",
  ...
  text1:
    "Experience the vibrant atmosphere of Carnevale at Venesla, where tradition meets modern celebration. Enjoy parades, music, and exquisite costumes that bring the streets to life.",
  text2: "Don't miss out on the chance to be part of this spectacular event. ",
  text3: "Book your tickets now and join us for an unforgettable celebration.",
};
